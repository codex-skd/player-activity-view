...
public class PlayerStatusManager {
    public final HashMap<UUID, PlayerStatus> lookupPlayerToStatus = new HashMap<>();
    ...
    public PlayerStatus getStatus(Player player) { return getStatus(player.getUUID()); }
    public PlayerStatus getStatus(UUID uuid) { return getStatus(uuid, false); }
    ...
    public Vec3 getBodyAngle(Player player) {
        return calculateViewVector(player.getXRot(), player.yBodyRot);
    }
