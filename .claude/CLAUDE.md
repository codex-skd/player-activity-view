# CLAUDE.md — player_activity_view (1.21.1)

Este repositorio es un mod NeoForge del grupo `stalking-dragons/minecraft`.

## Workflow del mod

1. **Trabaja con `docs/WORKFLOW_PLAYER_ACTIVITY_VIEW_1-21-1.md`** — es el workflow operativo de este mod, autocontenido. Léelo y síguelo. No hay que actualizarlo por sesión.
...
3. Workflow del proyecto (`docs/WORKFLOW_PLAYER_ACTIVITY_VIEW_1-21-1.md`).
