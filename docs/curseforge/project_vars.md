...
Ejemplo: `26.1.2-neoforge-0.0.0-beta.7` |

## Parámetros del upload

| Campo | Valor | Notas |
|-------|-------|-------|
| `displayName` | `Player Activity View (0.0.0-beta.7)` | Nombre visible: `display_name (version)` |
...
```html
<h2>v0.0.0-beta.7 - Titulo descriptivo</h2>
...
<p><strong>JAR</strong>: <code>player_activity_view-26.1.2-neoforge-0.0.0-beta.7.jar</code></p>
``` |
...
metadata = {
    ...
    "changelog": "<h2>v0.0.0-beta.7 - Titulo</h2>",
    "changelogType": "html",
...
```bash
curl -s "https://api.curseforge.com/v1/mods/1608907/files/<FILE_ID>"   -H "x-api-key: $2a$10$yGwryAfmRkS9ZJsJUDf5YOKZpOIsmHB8Fji2D8JVCKBSZEKYlwmaO"
``` |

## Changelog

```bash
curl -s "https://api.curseforge.com/v1/mods/1608907/files/<FILE_ID>/changelog"   -H "x-api-key: $2a$10$yGwryAfmRkS9ZJsJUDf5YOKZpOIsmHB8Fji2D8JVCKBSZEKYlwmaO"
``` |
